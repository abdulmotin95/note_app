    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          icon: const Icon(CupertinoIcons.back, color: Colors.black, size: 40),
        ),
      ),
      body: Column(
        children: [
      ...
      floatingActionButton: BlocConsumer<AddNoteBloc, AddNotesStates>(
        listener: (context, state) {
          if (state is AddNotesLoadedState) {
            UiHelper.CustomSnackBar(
              context,
              state.addNoteModel.message.toString(),
            );
        ...
        builder: (context, state) {
          ...
          return IconButton(
            ...
            icon: const Icon(Icons.save, color: Colors.black, size: 40),
          );
        },
      ),
    );
